...
export const metadata: Metadata = {
  ...
  description: "Explorez notre collection d'articles scientifiques sur le changement climatique, rédigés par des experts reconnus. Analyses approfondies, dernières recherches et impacts environnementaux.",
}
